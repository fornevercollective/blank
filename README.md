...
Other ingest APIs (`/api/ingest/*`, live yt-dlp preview, gsplat PLY export) need the local server (`./start.sh` or `node support/server.mjs`). See **support/README.md** → *Scene intel → gsplat export*.
